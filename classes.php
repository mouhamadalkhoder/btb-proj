			...
			<div class="row trainers_row">
				...
				<div class="col-lg-4 trainer_col">
					<div class="trainer">
						...
						<div class="trainer_content text-center">
							<div class="trainer_name">Johnny</div>
							<div class="trainer_title">Trainers, athletes and serious clients alike are looking for the toughest, most brutally productive training techniques to spice up their workouts and provide a truly unique challenge</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 trainer_col">
					<div class="trainer">
						...
						<div class="trainer_content text-center">
							<div class="trainer_name">Wafa</div>
							<div class="trainer_title">Trainers, athletes and serious clients alike are looking for the toughest, most brutally productive training techniques to spice up their workouts and provide a truly unique challenge</div>
						</div>
					</div>
				</div>
