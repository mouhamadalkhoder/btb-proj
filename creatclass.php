			...
			<div class="row">
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_form_container">
						<div class="contact_title"><h1>Workout</h1></div>
				<div class="contact_form" id="contact_form">
                 ...
                 <button class="contact_form_button button dropdown-toggle " type="button" data-toggle="dropdown">class
                  <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                      <li><a href="#">Strength Builder</a></li>
                      <li><a href="#">Engine builder</a></li>
                      <li><a href="#">Gymnastic</a></li>
                      </ul>
                      </div>
					  Workout date<input type="date" class="contact_form_input" placeholder="Workout date" required="required" name="date">
					  Workout time<input type="time" class="contact_form_input" placeholder="Workout time" required="required" name="time">
					  Workout type<input type="text" class="contact_form_input" placeholder="type" required="required" name="type">
					  Workout description<input type="text" class="contact_form_input" placeholder="description" required="required" name="description">	
							<button class="contact_form_button button" input type="submit" name="add"><span>Add a workout</span></button>
						</form>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_content">
						...
						<br>
						<div> <img src="images/gym13.jpg" alt="FoxPro" /></a> <span></span></div>
