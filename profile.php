			...
			<div class="row">
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_form_container">
						<div class="contact_title"><h1>Login</h1></div>
				<div class="contact_form" id="contact_form">
						<form action="#" class="contact_form" id="contact_form" method="post">
						<input type="text" class="contact_form_input" placeholder="Username" required="required" name="username">
							<input type="text" class="contact_form_input" placeholder="Password" required="required" name="password">
							
							<button class="contact_form_button button" input type="submit" name="login"><span>Login</span></button>
							<div class="contact_title">i dont have an account <span><a href="SIGNUP.php">sign up</a></div>
						</form>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 contact_col">
					<div class="contact_content">
						...
						<div> <img src="images/gym9.jpg" alt="FoxPro" /></a> <span></span></div>
